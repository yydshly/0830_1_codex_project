...
| 进行中 | [R-006 · Selector 能力研究（第 6 个研究子项目）](projects/selector-study/) | [oil-oil/selector v0.4.1 @ `d88e9a6`](https://github.com/oil-oil/selector/tree/d88e9a6c3c10821a5cc6d87447693d9507a76b35) | 视觉元素上下文能否降低 AI 前端修改歧义，并保持可控的信息量与隐私边界？ | Selector 是“人类视觉意图 → Agent 可审查任务包”的上下文编译器，不是自动改代码的 Agent；已完成六场景展厅、五维采用决策台与锁定源库真实运行 fixture。跨浏览器、框架源码映射和 Agent 成功率仍待受控实验。 [研究页](https://yydshly.github.io/0830_1_codex_project/projects/selector-study/) · [在线 Web](https://yydshly.github.io/0830_1_codex_project/projects/selector-study/showcase/) · [源库实跑](https://yydshly.github.io/0830_1_codex_project/projects/selector-study/showcase/source-demo/) | 2026-08-31 |
