...
| 进行中 | [R-003 · Dashi PPT Skill 能力与工程机制研究（第 3 个研究子项目）](projects/dashi-ppt-skill-study/) | [chuspeeism/dashi-ppt-skill 0.4.11 @ `7cb23347`](https://github.com/chuspeeism/dashi-ppt-skill/tree/7cb23347f91cda1a5519eafc8c040704e389535a) | 模板、模型与导出引擎如何分工，组织应沉淀什么？ | Dashi 本质是“预制主题/页面组件 + Agent 内容理解与有限编排 + 确定性装配/导出”：v1—v3 锁定模板，用 `props` / `contentMap` 填入文字、指标和媒体；v4 只在预置网格与主题 recipe 内重组。它不是整页生图；真正价值是把品牌、常用页型、容量规则和 QA 变成可执行模板系统。 [研究页](https://yydshly.github.io/0830_1_codex_project/projects/dashi-ppt-skill-study/) · [在线 Web](https://yydshly.github.io/0830_1_codex_project/projects/dashi-ppt-skill-study/showcase/) · [源库](https://github.com/chuspeeism/dashi-ppt-skill) | 2026-09-10 |
...
| 进行中 | [R-006 · Selector 能力研究（第 6 个研究子项目）](projects/selector-study/) | [oil-oil/selector v0.4.1 @ `d88e9a6`](https://github.com/oil-oil/selector/tree/d88e9a6c3c10821a5cc6d87447693d9507a76b35) | 复制网页元素时附带结构化上下文，能否降低 AI 前端修改的目标歧义？ | Selector 的本质是：选中网页元素，在复制时把 selector、locator、DOM/样式/框架线索和 instruction 一并带给下游 Agent。它不理解意图，也不自动改代码；已完成六场景展厅、五维采用决策台与锁定源库真实运行 fixture。 [研究页](https://yydshly.github.io/0830_1_codex_project/projects/selector-study/) · [在线 Web](https://yydshly.github.io/0830_1_codex_project/projects/selector-study/showcase/) · [源库实跑](https://yydshly.github.io/0830_1_codex_project/projects/selector-study/showcase/source-demo/) | 2026-08-31 |
