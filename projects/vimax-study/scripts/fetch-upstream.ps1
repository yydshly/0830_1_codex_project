...
$UpstreamUrl = "https://github.com/HKUDS/ViMax.git"
$UpstreamCommit = "05a48943878312d88fe5a016c12a9654940ecc43"
$ProjectRoot = (Resolve-Path (Join-Path $PSScriptRoot "..")).Path

if ([string]::IsNullOrWhiteSpace($Destination)) {
    $Destination = Join-Path $ProjectRoot "upstream\ViMax"
...
Write-Output "ViMax upstream is ready."
